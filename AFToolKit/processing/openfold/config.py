...
def model_config(
    ...
    if name == "initial_training":
        ...
        c.data.train.max_msa_clusters = 1  # 512
...
config = mlc.ConfigDict(
    {
        "data": {
            ...
            "train": {
                "fixed_size": True,
                "subsample_templates": False,  # True,
                "masked_msa_replace_fraction": 0,  # 0.15,
                "max_msa_clusters": 2,  # 2,#128,#128,
                "max_extra_msa": 1,  # 024,
                "max_template_hits": 1,  # 4,
                "max_templates": 1,  # 4,
                "shuffle_top_k_prefiltered": 20,
                "crop": True,  # False,#True,
                "crop_size": 256,#150,  # 256,
                "supervised": True,
                "clamp_prob": 0.9,
                "max_distillation_msa_clusters": 1000,
                "uniform_recycling": False,  # True,
                "distillation_prob": 0,  # 0.75,
            },
            "data_module": {
                "use_small_bfd": False,
                "data_loaders": {
