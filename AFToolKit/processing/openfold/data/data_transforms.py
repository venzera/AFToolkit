...
from AFToolKit.processing.openfold.config import (NUM_EXTRA_SEQ, NUM_MSA_SEQ, NUM_RES,
                                   NUM_TEMPLATES)
from AFToolKit.processing.openfold.np import residue_constants as rc
from AFToolKit.processing.openfold.utils.rigid_utils import Rigid, Rotation
from AFToolKit.processing.openfold.utils.tensor_utils import (batched_gather, tensor_tree_map,
                                               tree_map)
...
def fix_templates_aatype(protein):
    ...
    print("fix_templates_aatype adjust!")
    return protein
